...
import { DSColor, DSTypography, DSSpacingRadius, DSAtoms, DSMolecules, DSOrganisms } from './CXODesignSystem';
...
const Section: React.FC<SectionProps> = ({ index, title, annotation, children }) => (
  <section className="relative border-t border-dashed border-white/10">
    ...
    <div
      ...
      style={{ right: '100%', marginRight: 32, top: 56, width: 200 }}
    >
    ...
    <div
      ...
      style={{ left: '100%', marginLeft: 32, top: 60, width: 220 }}
    >
    ...
    <motion.div {...fadeUp} className="px-5 md:px-10 py-14 space-y-8">
...
const Panel: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = '' }) => (
  <div className={`rounded-xl border border-white/10 p-6 md:p-7 ${className}`} style={{ backgroundColor: CXO.panel }}>
    {children}
  </div>
);
...
const FigureCard: React.FC<{ src: string; alt: string; caption: string }> = ({ src, alt, caption }) => (
  <figure className="rounded-xl border border-white/10 overflow-hidden" style={{ backgroundColor: CXO.panel }}>
    ...
    <figcaption className="px-5 py-3.5 text-xs text-gray-500 border-t border-white/10">{caption}</figcaption>
  </figure>
);
      ...
      <div className="relative flex-1 overflow-y-auto">
        <div className="relative mx-auto" style={{ maxWidth: COL * 2 }}>
          ...
          <motion.section
            ...
            className="px-5 md:px-10 pt-20 pb-16"
          >
            <div className="flex items-center gap-2 text-[11px] font-medium tracking-[0.18em] uppercase text-gray-500 mb-6">
              <ShieldAlert size={13} style={{ color: CXO.accent }} />
              Shared under NDA — please don't redistribute
            </div>
            <h1 className="text-4xl md:text-6xl font-semibold text-white tracking-tight mb-5">
          ...
          {/* ─ 06 Navigation ─ */}
          <Section index="06" title="Navigation that scales" annotation="Sidebar v1 → v3">
            <p className="text-base text-gray-300 leading-relaxed max-w-2xl">
          ...
          {/* ─ 07 InChat ─ */}
          <Section index="07" title="Briefing agents like teammates" annotation="InChat, R1 → R3">
            <p className="text-base text-gray-300 leading-relaxed max-w-2xl">
          ...
          {/* ─ 08 Onboarding ─ */}
          <Section index="08" title="Onboarding without the maze" annotation="Three steps, one skip">
            <p className="text-base text-gray-300 leading-relaxed max-w-2xl">
          ...
          {/* ─ 09 Enterprise surface ─ */}
          <Section index="09" title="The enterprise surface" annotation="Workspaces, teams, credits">
            <p className="text-base text-gray-300 leading-relaxed max-w-2xl">
          ...
          {/* ─ 10 Outcomes ─ */}
          <Section index="10" title="Where it landed" annotation="Outcomes & learnings">
          ...
          <div className="relative border-t border-dashed border-white/10">
            <Crosshair side="left" />
            <Crosshair side="right" />
            <div className="px-5 md:px-10 py-14 space-y-4">
