    ...
    <div ref={containerRef} tabIndex={-1} className="fixed inset-0 z-[110] bg-dark/95 backdrop-blur-md overflow-y-auto cursor-auto outline-none">
        <div className="min-h-full w-full bg-dark text-light selection:bg-accent selection:text-black pb-20">
            ...
            <div className="sticky top-0 z-50 bg-dark/90 backdrop-blur-lg border-b border-white/10 px-6 py-4 flex justify-between items-center">
                <button 
                    onClick={onClose}
                    className="group flex items-center gap-2 text-gray-400 hover:text-accent transition-colors text-xs uppercase tracking-widest font-bold cursor-hover"
                >
            ...
            <div className="max-w-6xl mx-auto px-6 py-20 md:py-32">
                ...
                <div className="text-center max-w-4xl mx-auto mb-20">
                    <div className="flex flex-wrap gap-3 justify-center mb-8">
                        {project.tags.map((tag, idx) => (
                             <span key={idx} className="text-[10px] font-bold uppercase tracking-[0.2em] text-black bg-accent px-3 py-1">
                                {tag}
                             </span>
                        ))}
                    </div>
                ...
                {/* Hero Image */}
                <div className="w-full aspect-[16/9] md:aspect-[21/9] overflow-hidden bg-white/5 mb-20 border border-white/10">
                    <img 
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-y border-white/10 py-12 mb-24">
                    <div>
                        <h3 className="text-xs font-bold text-accent uppercase tracking-widest mb-3">Role</h3>
                        <p className="text-lg text-white font-medium">{detailedContent.role || 'Product Designer'}</p>
                    </div>
                    <div>
                        <h3 className="text-xs font-bold text-accent uppercase tracking-widest mb-3">Timeline</h3>
                        <p className="text-lg text-white font-medium">{detailedContent.timeline || 'N/A'}</p>
                    </div>
                    <div className="col-span-2 md:col-span-2">
                        <h3 className="text-xs font-bold text-accent uppercase tracking-widest mb-3">Target Audience</h3>
                    ...
                    {detailedContent.tools && detailedContent.tools.length > 0 && (
                        <div className="col-span-2 md:col-span-4 border-t border-white/10 pt-8 mt-4">
                            <h3 className="text-xs font-bold text-accent uppercase tracking-widest mb-4">Tools & Technologies</h3>
                ...
                <div className="space-y-32">
                    ...
                    <section className="space-y-12">
                        <div className="space-y-8">
                            ...
                            {detailedContent.challenges && detailedContent.challenges.length > 0 && (
                                <div className="mt-8">
                                    <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-4">Key Challenges</h3>
                            ...
                            {detailedContent.goals && detailedContent.goals.length > 0 && (
                                <div className="mt-8 bg-white/5 border border-white/10 p-8">
                                    <h3 className="text-sm font-bold text-accent uppercase tracking-widest mb-6">Project Goals</h3>
                        ...
                        <div className="grid md:grid-cols-12 gap-12">
                            {detailedContent.operatingRange && (
                                <div className="md:col-span-5 bg-white/5 border border-white/10 p-6 space-y-6">
                                    <h3 className="text-xs font-bold text-accent uppercase tracking-widest border-b border-white/10 pb-3">Operating Range</h3>
                                    <div>
                                        <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">Scope</h4>
                                        <p className="text-sm text-gray-300">{detailedContent.operatingRange.scope}</p>
                                    </div>
                                    <div>
                                        <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">Ambiguity</h4>
                                        <p className="text-sm text-gray-300">{detailedContent.operatingRange.ambiguity}</p>
                                    </div>
                                    <div>
                                        <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">Dependencies</h4>
                            ...
                            {detailedContent.measurableDelta && (
                                <div className={`space-y-8 ${detailedContent.operatingRange ? 'md:col-span-7' : 'md:col-span-12'}`}>
                                    <div className="grid sm:grid-cols-2 gap-6">
                                        <div className="bg-white/5 border border-white/10 p-6 border-l-4 border-l-red-500/50">
                                            <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Before</h4>
                                            <p className="text-sm text-gray-300 leading-relaxed">{detailedContent.measurableDelta.before}</p>
                                        </div>
                                        <div className="bg-white/5 border border-white/10 p-6 border-l-4 border-l-emerald-500/50">
                                            <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">After</h4>
                                            <p className="text-sm text-gray-300 leading-relaxed">{detailedContent.measurableDelta.after}</p>
                                        </div>
                                    </div>
                                    <div className="bg-white/5 border border-white/10 p-6">
                                        <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Why it moved</h4>
                            ...
                            <div className="grid md:grid-cols-2 gap-12">
                                {detailedContent.decisionPoints && (
                                    <div className="space-y-8">
                                        ...
                                        {detailedContent.decisionPoints.map((decision, idx) => (
                                            <div key={idx} className="bg-white/5 border border-white/10 p-6 hover:border-accent/50 transition-colors duration-500">
                                                <div className="mb-4">
                                                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">Context</h4>
                                ...
                                {detailedContent.engineeringCollab && (
                                    <div className="space-y-8">
                                        ...
                                        <div className="bg-white/5 border border-white/10 p-6 space-y-8">
                                            {detailedContent.engineeringCollab.techConstraints && (
                                                <div>
                                                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-accent mb-3">Technical Constraints</h4>
                                            ...
                                            {detailedContent.engineeringCollab.edgeCases && (
                                                <div>
                                                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Edge Cases Handled</h4>
                                                    <ul className="space-y-2">
                                            ...
                                            {detailedContent.engineeringCollab.tradeOffs && (
                                                <div>
                                                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Implementation Trade-offs</h4>
                                                    <ul className="space-y-2">
                                ...
                                {detailedContent.systemThinking && (
                                    <div className="space-y-8 md:col-span-2">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div className="bg-white/5 border border-white/10 p-6">
                                                <h4 className="text-[10px] font-bold uppercase tracking-widest text-accent mb-3">Architecture Summary</h4>
                                                <p className="text-sm text-gray-300 leading-relaxed">{detailedContent.systemThinking.summary}</p>
                                            </div>
                                            <div className="bg-white/5 border border-white/10 p-6">
                                                <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Evolution</h4>
                                                <p className="text-sm text-gray-300 leading-relaxed">{detailedContent.systemThinking.evolution}</p>
                                            </div>
                                            <div className="bg-white/5 border border-white/10 p-6">
                                                <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Reuse & Scale</h4>
                        ...
                        <section>
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                {detailedContent.research.insights.map((insight, idx) => (
                                    <div key={idx} className="bg-white/5 border border-white/10 p-6 flex items-start gap-4">
                        ...
                        <section>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                {detailedContent.personas.map((persona, idx) => (
                                    <div key={idx} className="bg-white/5 border border-white/10 p-8 hover:border-accent/50 transition-colors duration-500 group">
                                        <div className="mb-8">
                                        ...
                                        <div className="grid sm:grid-cols-2 gap-8">
                                            <div>
                                                <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-4">Goals</h4>
                                                <ul className="space-y-2">
                                            ...
                                            <div>
                                                <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-4">Pain Points</h4>
                                                <ul className="space-y-2">
                        ...
                        <section>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {detailedContent.userJourney.map((journey, idx) => (
                                    <div key={idx} className="bg-white/5 border border-white/10 p-8 hover:border-accent/50 transition-colors duration-500">
                                        <h3 className="text-xl font-bold text-white font-display mb-6">{journey.stage}</h3>
                                        
                                        <div className="mb-6">
                                            <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Actions</h4>
                                            <ul className="space-y-2">
                                        ...
                                        <div className="mb-6">
                                            <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Pain Points</h4>
                                            <ul className="space-y-2">
                                        ...
                                        <div>
                                            <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-3">Opportunities</h4>
                                            <ul className="space-y-2">
                    ...
                    {detailedContent.eisenMatrix && (
                        <section>
                            ...
                            <div className="grid md:grid-cols-2 gap-4 h-full">
                                {/* Quadrant 1 */}
                                <div className="bg-red-900/10 border border-red-500/20 p-8 relative hover:bg-red-900/20 transition-colors">
                                    <span className="absolute top-4 right-4 text-[10px] font-bold text-red-500 uppercase tracking-widest">Urgent & Important</span>
                                ...
                                {/* Quadrant 2 */}
                                <div className="bg-blue-900/10 border border-blue-500/20 p-8 relative hover:bg-blue-900/20 transition-colors">
                                    <span className="absolute top-4 right-4 text-[10px] font-bold text-blue-500 uppercase tracking-widest">Not Urgent & Important</span>
                                ...
                                {/* Quadrant 3 */}
                                <div className="bg-orange-900/10 border border-orange-500/20 p-8 relative hover:bg-orange-900/20 transition-colors">
                                    <span className="absolute top-4 right-4 text-[10px] font-bold text-orange-500 uppercase tracking-widest">Urgent & Not Important</span>
                                ...
                                {/* Quadrant 4 */}
                                <div className="bg-white/5 border border-white/10 p-8 relative hover:bg-white/10 transition-colors">
                                    <span className="absolute top-4 right-4 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Not Urgent & Not Important</span>
                    ...
                    {detailedContent.sitemap && (
                        <section>
                            ...
                            <div className="bg-white/5 border border-white/10 p-8 md:p-12 overflow-x-auto">
                                <div className="flex flex-nowrap gap-8 min-w-max justify-center mx-auto">
                                    {detailedContent.sitemap.map((section, idx) => (
                                        <div key={idx} className="flex flex-col items-center gap-4 group">
                                            {/* Node */}
                                            <div className="w-40 h-16 flex items-center justify-center bg-dark border border-white/20 shadow-sm font-bold text-white z-10 group-hover:border-accent transition-colors font-display tracking-tight text-center px-2">
                                                {section.title}
                                            </div>
                                            {/* Connector */}
                                            ...
                                            <div className="flex flex-col gap-2">
                                                {section.items.map((item, i) => (
                                                    <div key={i} className="px-4 py-2 bg-white/5 border border-white/5 rounded-sm text-[10px] text-gray-400 text-center w-40 font-mono">
                                                        {item}
                                                    </div>
                                                ))}
                                            </div>
                                            ...
                                            {detailedContent.designSystem.typography.scale.map((type, idx) => (
                                                <div key={idx} className="flex items-baseline border-b border-white/10 pb-4">
                                                    ...
                                                    <div className="flex-1">
                                                        <div style={{ fontSize: type.size, lineHeight: type.lineHeight, fontWeight: type.weight, color: 'white' }}>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                        {detailedContent.designSystem.colors.map((color, idx) => (
                                            <div key={idx} className="space-y-3 group">
                                                <div 
                                                    className="w-full aspect-square shadow-sm flex items-end p-4 transition-transform group-hover:scale-105 duration-300 relative overflow-hidden"
                                                    style={{ backgroundColor: color.hex }}
                                                >
                                                    {/* Darken text if color is light, lighten if dark */}
                                                    <span className="text-[10px] font-bold uppercase tracking-widest opacity-100 z-10" 
                                            ...
                                            <div className="space-y-8">
                                                ...
                                                <div className="space-y-6">
                                                    {detailedContent.processSteps!.map((step, idx) => (
                                                        <div key={idx} className="bg-white/5 border border-white/10 p-6 flex gap-4">
                        ...
                        <div className="space-y-24">
                            {detailedContent.images.map((img, idx) => (
                                 <div key={idx} className="group relative">
                                    <div className="overflow-hidden border border-white/10 hover:border-accent/50 transition-all duration-500 p-6">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {detailedContent.solutionImages.map((img, idx) => (
                                    <div key={idx} className="overflow-hidden border border-white/10 hover:border-accent/50 transition-all duration-500 group">
                                        <img
                                            src={img}
                ...
                <div className="mt-32 pt-16 border-t border-white/10 text-center">
                    <button 
                        onClick={onClose}
                        className="px-12 py-4 border border-white text-white text-xs font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-black transition-all duration-300 cursor-hover"
                    >
                        Close Protocol
                    </button>
                </div>
